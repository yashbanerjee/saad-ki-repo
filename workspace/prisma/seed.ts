...
const PERMISSION_DEFINITIONS = [
  ...
  { name: 'View Leads', slug: 'leads:read', module: 'leads' },
  { name: 'Manage Deals', slug: 'deals:manage', module: 'deals' },
  { name: 'View Deals', slug: 'deals:read', module: 'deals' },
  { name: 'Manage Contacts', slug: 'contacts:manage', module: 'contacts' },
  { name: 'View Contacts', slug: 'contacts:read', module: 'contacts' },
  { name: 'Manage Organizations', slug: 'organizations:manage', module: 'organizations' },
  { name: 'View Organizations', slug: 'organizations:read', module: 'organizations' },
  { name: 'Manage CRM Tasks', slug: 'crm_tasks:manage', module: 'crm_tasks' },
  { name: 'View CRM Tasks', slug: 'crm_tasks:read', module: 'crm_tasks' },
